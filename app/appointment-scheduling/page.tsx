        ...
        <main className="flex-1 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {modules.map((module, index) => (
                <div key={index} className="bg-white rounded-lg border p-6">
                  ...
                  <Link href={module.link} className="text-blue-600 text-sm font-medium hover:underline">
          ...
          <div className="mb-8">
            <div className="bg-white rounded-lg border p-6">
              ...
              <Link href="/calendar-view" className="text-blue-600 text-sm font-medium hover:underline">
                Open Calendar &rarr;
              </Link>
            </div>
          </div>
