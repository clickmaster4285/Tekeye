...
// Dummy credentials for Pakistan Customs (demo only)
const DEMO_CREDENTIALS = {
  username: "pakistan_customs",
  password: "Customs@2024",
}
...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden bg-[#f0f4f8]">
      ...
      {/* Left panel - Pakistan Customs branding */}
            ...
            <form onSubmit={handleSubmit}>
              <CardContent className="space-y-5">
                ...
                <div className="rounded-xl border border-[#3b82f6]/20 bg-[#3b82f6]/5 px-4 py-3.5">
                  ...
                  <div className="space-y-1 font-mono text-sm text-foreground">
                    <p>
                      Username:{" "}
                      <span className="font-semibold text-[#1d4ed8]">{DEMO_CREDENTIALS.username}</span>
                    </p>
                    <p>
                      Password:{" "}
                      <span className="font-semibold text-[#1d4ed8]">{DEMO_CREDENTIALS.password}</span>
                    </p>
                  </div>
                </div>
              </CardContent>
              <CardFooter className="flex flex-col gap-4 pb-8 pt-2">
                ...
                <p className="text-center text-xs text-muted-foreground">
                  Use demo credentials above for testing. Authorized users use official credentials.
                </p>
              </CardFooter>
            </form>
          </Card>
