...
const defaultRows: WarehouseRow[] = [
  { id: "1", code: "WH-001", name: "Main Distribution Center", location: "Karachi", capacity: "10,000", status: "Active" },
  { id: "2", code: "WH-002", name: "North Regional Hub", location: "Lahore", capacity: "8,500", status: "Active" },
  { id: "3", code: "WH-003", name: "Customs Bonded Warehouse", location: "Port Qasim", capacity: "12,000", status: "Active" },
  { id: "4", code: "WH-004", name: "Transit Warehouse", location: "Islamabad", capacity: "5,200", status: "Active" },
  { id: "5", code: "WH-005", name: "Cold Storage Unit", location: "Faisalabad", capacity: "2,800", status: "Maintenance" },
]
...
export default function WarehouseSetupPage() {
  ...
  const [form, setForm] = useState({ code: "", name: "", location: "", capacity: "", status: "Active" })
  ...
  const openAdd = () => {
    setForm({ code: "", name: "", location: "", capacity: "", status: "Active" })
    setOpen(true)
  }
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 gap-4 flex-wrap">
            <div>
              ...
              <CardDescription>Manage warehouse profiles and settings. Data saved in localStorage.</CardDescription>
            </div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <p className="text-sm text-muted-foreground">New warehouse. Stored in localStorage.</p>
          </DialogHeader>
